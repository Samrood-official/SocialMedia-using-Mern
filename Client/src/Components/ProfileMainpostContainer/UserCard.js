...
const UserCard = ({ name, userName, profilePic, id, type, setCallFriend, callFriend }) => {
    ...
    if (type === 'followers') {
        ...
        // return (
        //     <>
        //         <div className={`${bg} m-2 p-2 border border-zinc-400 rounded-lg shadow-md flex flex-col justify-center`}>
        //             {profilePic ?
        //                 <img src={profilePic} alt={name} className="w-16 h-16 rounded-full mx-auto" /> :
        //                 <div className='border border-zinc-400 w-16 h-16 rounded-full mx-auto'>
        //                     <FaUser className='w-full h-full rounded-full' />
        ...
        //             <p className="text-gray-500 text-sm text-center">{userName}</p>
        //             <button onClick={() =>{
        //                  handleRemoveFollower(id, token, setFollowerStat, dispatch)
        //                 } 
        //             }
        //                  className=" h-8 text-red-700 font-bold rounded-md px-3 mx-4 ">
        //                 {followerStat}
        //             </button>
        //         </div>
        //     </>
